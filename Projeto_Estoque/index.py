...
# VALIDACAO DO FORMATO E SE A DATA SE ENCONTRA DO TEMPO CORRETO
...
# LISTAR USUARIOS CADASTRADOS DURANTE ALGUMA ACAO (cadastrar produto, entrada estoque e saida estoque)
...
def cadastrar_produto():
    ...
    # VALIDAR SE O ID INFORMADO POSSUI USUARIO VINCULADO
    while True:
...
# LISTAR PRODUTOS JA CADASTRADOS
def listar_produtos():
...
# ENTRADA DE MAIS VOLUME DE UM PRODUTO JA CADASTRADO
def entrada_estoque():
    ...
    # MOSTRA OPCAO DE PRODUTOS CADASTRADOS PARA ADICAO DE MAIS UNIDADES
    while True:
        produto = int(input("\nID do produto: "))
    ...
    # MOSTRA OPCOES DE USUARIOS QUE JA ESTAO CADASTRADOS E PODEM REALIZAR A ACAO DE ADICAO DE PRODUTOS
    while True:
        usuario = int(input("\nID do usuário: "))
...
def saida_estoque():
    ...
    # MOSTRA OPCAO DE PRODUTOS CADASTRADOS PARA REMOCAO DE UNIDADES
    while True:
        produto = int(input("\nID do produto: "))
    ...
    # MOSTRA OPCOES DE USUARIOS QUE JA ESTAO CADASTRADOS E PODEM REALIZAR A SUBTRACAO DE PRODUTOS
    while True:
        usuario = int(input("\nID do usuário: "))
    ...
    # VALIDA SE A QUATIA INFORMADA A SAIR DO ESTOQUE REALMENTE TEM DISPONIVEL NO ESTOQUE PARA A SAIDA
    while True:
...
# RELATORIO GERAL DE MOVIMENTACAO DE PRODUTOS NO ESTOQUE
